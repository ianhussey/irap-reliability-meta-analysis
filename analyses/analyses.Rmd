...
meta_effect <- 
  paste0("Meta analysis: k = ", fit_oddeven$k, 
         ...
         ", 95% CR [", round(transf.iabt(predictions_oddeven$pi.lb), 2), ", ", 
         round(transf.iabt(predictions_oddeven$pi.ub), 2), "]") 
...
meta_effect <- 
  paste0("Meta analysis: k = ", fit_firstsecond$k, 
         ...
         ", 95% CR [", round(transf.iabt(predictions_firstsecond$pi.lb), 2), ", ", 
         round(transf.iabt(predictions_firstsecond$pi.ub), 2), "]") 
...
meta_effect <- 
  paste0("Meta analysis: k = ", fit_internal_consistency_permuted_estimates$k, 
         ...
         ", 95% CR [", round(transf.iabt(predictions_permutations$pi.lb), 2), ", ", 
         round(transf.iabt(predictions_permutations$pi.ub), 2), "]") 
...
meta_effect <- 
  paste0("Meta analysis: k = ", fit_internal_consistency_permuted_estimates_sensitivity$k, 
         ...
         ", 95% CR [", round(transf.iabt(predictions_permutations_sensitivity$pi.lb), 2), ", ", 
         round(transf.iabt(predictions_permutations_sensitivity$pi.ub), 2), "]") 
...
meta_effect <- 
  paste0("Meta analysis: k = ", fit_test_retest_r$k, 
         ...
         ", 95% CR [", round(transf.ztor(predictions_test_retest_r$pi.lb), 2), ", ", 
         round(transf.ztor(predictions_test_retest_r$pi.ub), 2), "]") 
...
meta_effect <- 
  paste0("Meta analysis: k = ", fit_test_retest_icc$k, 
         ...
         ", 95% CR [", round(predictions_test_retest_icc$pi.lb, 2), ", ", 
         round(predictions_test_retest_icc$pi.ub, 2), "]") 
