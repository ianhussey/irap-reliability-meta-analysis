...
# performance stats
performance_criteria <- data_trial_level_temp_1 |>
  ...
  mutate(met_performance_criteria = ifelse(median_rt_consistent <= 2000 & 
                                             median_rt_inconsistent <= 2000 & 
                                             percent_accuracy_consistent >= .80 |
                                             percent_accuracy_inconsistent >= .80, TRUE, FALSE))

# combine
data_trial_level_temp_2 <- data_trial_level_temp_1 |>
  left_join(performance_criteria, by = c("unique_id", "timepoint")) |>
