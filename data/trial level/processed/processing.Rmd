...
chad_political_attitudes <- read_csv("../intermediate/IRAP 2012 VB6 format files/chad political attitudes 2016.csv") %>%
  ...
  right_join(read_csv("../intermediate/IRAP 2012 VB6 format files/chad political attitudes 2016.csv") %>%
               mutate(participant = as.factor(participant)) %>%
...
chad_mental_illness_stigma <- read_csv("../intermediate/IRAP 2012 VB6 format files/chad mental illness stigma.csv") %>%
  mutate(participant = as.factor(participant)) %>%
  ...
  mutate_at(vars(participant, data_type, 
                 stimuli_category_1, stimuli_category_2, stimuli_attribute_1, stimuli_attribute_2), as.character) %>%
  filter(grepl("Target", data_type) & grepl("Latency", data_type) & t1_c_tt1 != 0) %>%
  full_join(read_csv("../intermediate/IRAP 2012 VB6 format files/chad mental illness stigma.csv") %>%
              ...
              distinct(participant, .keep_all = TRUE), by = "participant") %>%
  right_join(read_csv("../intermediate/IRAP 2012 VB6 format files/chad mental illness stigma.csv") %>%
               mutate(participant = as.factor(participant)) %>%
               select(participant, block_order) %>%
               distinct(participant, .keep_all = TRUE), by = "participant") %>%
  mutate(block_order = dplyr::recode(block_order,
...
chad_bodyImage_IRAP1 <- read_csv("../intermediate/IRAP 2012 VB6 format files/chad body image 1.csv") %>%
  mutate(participant = as.factor(participant)) %>%
  select(-contains("fp_")) %>%
...
chad_bodyImage_IRAP2 <- read_csv("../intermediate/IRAP 2012 VB6 format files/chad body image 2.csv") %>%
  mutate(participant = as.factor(participant)) %>%
  select(-contains("fp_")) %>%
  mutate_at(vars(-experiment, -participant, -block_order, -data_type, -rule_1), as.character) %>%
  mutate_at(vars(-experiment, -participant, -block_order, -data_type, -rule_1), as.numeric) %>%
...
chad_gender_IRAP1 <- read_csv("../intermediate/IRAP 2012 VB6 format files/chad gender 1.csv") %>%
  mutate(participant = as.factor(participant)) %>%
  select(-contains("fp_")) %>%
  mutate_at(vars(-experiment, -participant, -block_order, -data_type, -rule_1), as.character) %>%
  mutate_at(vars(-experiment, -participant, -block_order, -data_type, -rule_1), as.numeric) %>%
...
chad_gender_IRAP2 <- read_csv("../intermediate/IRAP 2012 VB6 format files/chad gender 2.csv") %>%
  mutate(participant = as.factor(participant)) %>%
  select(-contains("fp_")) %>%
  mutate_at(vars(-experiment, -participant, -block_order, -data_type, -rule_1), as.character) %>%
  mutate_at(vars(-experiment, -participant, -block_order, -data_type, -rule_1), as.numeric) %>%
...
chad_lincolnHitlerFriendEnemy_IRAP1 <- read_csv("../intermediate/IRAP 2012 VB6 format files/chad lincolnHitler FriendEnemy 1.csv") %>%
  mutate(participant = as.factor(participant)) %>%
  select(-contains("fp_")) %>%
  mutate_at(vars(-experiment, -participant, -block_order, -data_type, -rule_1), as.character) %>%
  mutate_at(vars(-experiment, -participant, -block_order, -data_type, -rule_1), as.numeric) %>%
...
chad_lincolnHitlerFriendEnemy_IRAP2 <- read_csv("../intermediate/IRAP 2012 VB6 format files/chad lincolnHitler FriendEnemy 2.csv") %>%
  mutate(participant = as.factor(participant)) %>%
  select(-contains("fp_")) %>%
  mutate_at(vars(-experiment, -participant, -block_order, -data_type, -rule_1), as.character) %>%
  mutate_at(vars(-experiment, -participant, -block_order, -data_type, -rule_1), as.numeric) %>%
...
chad_lincolnHitlerFriendEnemy_IRAP3 <- read_csv("../intermediate/IRAP 2012 VB6 format files/chad lincolnHitler FriendEnemy 3.csv") %>%
  mutate(participant = as.factor(participant)) %>%
  select(-contains("fp_")) %>%
  mutate_at(vars(-experiment, -participant, -block_order, -data_type, -rule_1), as.character) %>%
  mutate_at(vars(-experiment, -participant, -block_order, -data_type, -rule_1), as.numeric) %>%
...
faking_instructions <- read_csv("../intermediate/IRAP 2012 VB6 format files/chad friendenemy participants who received faking instructions.csv") %>%
...
chad_race_IRAP1 <- read_csv("../intermediate/IRAP 2012 VB6 format files/chad race 1.csv") %>%
  mutate(participant = as.factor(participant)) %>%
  select(-contains("fp_")) %>%
  mutate_at(vars(-experiment, -participant, -block_order, -data_type, -rule_1), as.character) %>%
  mutate_at(vars(-experiment, -participant, -block_order, -data_type, -rule_1), as.numeric) %>%
...
chad_race_IRAP2 <- read_csv("../intermediate/IRAP 2012 VB6 format files/chad race 2.csv") %>%
  mutate(participant = as.factor(participant)) %>%
  select(-contains("fp_")) %>%
  mutate_at(vars(-experiment, -participant, -block_order, -data_type, -rule_1), as.character) %>%
  mutate_at(vars(-experiment, -participant, -block_order, -data_type, -rule_1), as.numeric) %>%
...
chad_religion_IRAP1 <- read_csv("../intermediate/IRAP 2012 VB6 format files/chad religion 1.csv") %>%
  mutate(participant = as.factor(participant)) %>%
  select(-contains("fp_")) %>%
  mutate_at(vars(-experiment, -participant, -block_order, -data_type, -rule_1), as.character) %>%
  mutate_at(vars(-experiment, -participant, -block_order, -data_type, -rule_1), as.numeric) %>%
...
chad_religion_IRAP2 <- read_csv("../intermediate/IRAP 2012 VB6 format files/chad religion 2.csv") %>%
  mutate(participant = as.factor(participant)) %>%
  select(-contains("fp_")) %>%
  mutate_at(vars(-experiment, -participant, -block_order, -data_type, -rule_1), as.character) %>%
  mutate_at(vars(-experiment, -participant, -block_order, -data_type, -rule_1), as.numeric) %>%
...
ian_death <- read_csv("../intermediate/IRAP 2012 VB6 format files/ian death.csv") %>%
  mutate(participant = as.factor(participant)) %>%
  select(-contains("fp_")) %>%
...
ian_race <- read_csv("../intermediate/IRAP 2012 VB6 format files/ian race.csv") %>%
  mutate(participant = as.factor(participant)) %>%
  select(-contains("fp_")) %>%
  mutate_at(vars(-experiment, -participant, -block_order, -data_type), as.character) %>%
  mutate_at(vars(-experiment, -participant, -block_order, -data_type), as.numeric) %>%
...
data_demographics <- read_csv("../intermediate/IRAP 2012 VB6 format files/demographics and performance criteria data.csv") %>%
...
data_input <- bind_rows(read_csv("../intermediate/IRAP 2012 VB6 format files/ian countries 1.csv"),
                        #read_csv("../intermediate/IRAP 2012 VB6 format files/ian disgust.csv"),
                        read_csv("../intermediate/IRAP 2012 VB6 format files/ian faking studies.csv"),
                        read_csv("../intermediate/IRAP 2012 VB6 format files/ian hunger.csv"),
                        read_csv("../intermediate/IRAP 2012 VB6 format files/ian shapes and colors study 2.csv"),
                        read_csv("../intermediate/IRAP 2012 VB6 format files/ian shapes and colors study 3.csv")) %>%
  mutate(stimulus_number = str_remove_all(trial_and_data_type, " Raw Latency")) %>%
  # drop blocks 4-6 (present in the disgust IRAP only)
...
data_completeness <- data_input %>%
  gather(trial_and_block, rt, c("tt1_block1_con", "tt2_block1_con", "tt3_block1_con", "tt4_block1_con", 
                                ...
                                "tt1_block3_incon", "tt2_block3_incon", "tt3_block3_incon", "tt4_block3_incon")) %>%
  count(unique_id) %>%
  filter(n %in% c(288, 384, 480)) # methodologically plausible number of trials
...
nb other sexuality data in the faking dataset

```{r}

data_input_disgust <- read_csv("../intermediate/IRAP 2012 VB6 format files/ian disgust.csv") 
...
data_disgust <- data_input_disgust %>%
  semi_join(data_completeness, by = "unique_id") %>%
  filter(str_detect(trial_and_data_type, "Raw Latency")) %>%
  gather(trial_and_block, rt, c("tt1_block1_con", "tt2_block1_con", "tt3_block1_con", "tt4_block1_con", 
                                "tt1_block1_incon", "tt2_block1_incon", "tt3_block1_incon", "tt4_block1_incon", 
...
data_input_sexuality <- read_csv("../intermediate/IRAP 2012 VB6 format files/ian sexuality test retest.csv")
...
data_sexuality <- data_input_sexuality %>%
...
chad_personality_temp <- read_csv("../intermediate/IRAP 2012 VB6 format files/chad personality.csv") %>%
  mutate(participant = as.factor(participant)) %>%
  ...
  mutate_at(vars(experiment, participant, data_type, 
                 stimuli_category_1, stimuli_category_2, stimuli_attribute_1, stimuli_attribute_2), as.character) %>%
  filter(grepl("Target", data_type) & grepl("Latency", data_type) & t1_c_tt1 != 0) %>%
  right_join(read_csv("../intermediate/IRAP 2012 VB6 format files/chad personality.csv") %>%
               mutate(participant = as.factor(participant)) %>%
               select(participant, block_order) %>%
               distinct(participant, .keep_all = TRUE), by = "participant") %>%
  mutate(block_order = dplyr::recode(block_order,
...
data_goirap <- 
  bind_rows(read_csv("../intermediate/GO-IRAP format files/ian countries 2 acknowledge.csv") %>%
              select(unique_id, 
                     experiment,
                     ...
                     accuracy,
                     isTestBlock),
            read_csv("../intermediate/GO-IRAP format files/ian countries 2 care.csv") %>%
              select(unique_id, 
                     experiment,
                     gender = participantGender,
                     age = participantAge, 
                     ...
                     accuracy,
                     isTestBlock),
            read_csv("../intermediate/GO-IRAP format files/ian shapes and colors study 1.csv") %>%
              select(unique_id, 
                     experiment,
                     gender = participantGender,
                     age = participantAge, 
...
data_trial_level_temp <- 
  ...
  mutate(timepoint = ifelse(is.na(timepoint), 1, timepoint),
         ...
         block_order = ifelse(block_order == "Consistent", "con first",
                              ifelse(block_order == "Inconsistent", "incon first", block_order))) %>%
  ...
  mutate(trial_odd_even = ifelse(row_number() %% 2 == 1, "odd", "even")) %>%
  select(unique_id, 
         #participant, 
...
data_trial_level <- semi_join(data_trial_level_temp, data_correct_n_trials, by = c("unique_id", "timepoint"))
