...
text(-1.4, 41, "Study", pos = 4)
text(1.6, 41, "Spearman-Brown correlation [95% CI]", pos = 2)
...
text(-1.4, 41, "Study", pos = 4)
text(1.6, 41, bquote(paste("Cronbach's ", alpha, " [95% CI]")), pos = 2)
...
tibble(response_options = c("D", "A"),
       alpha = c(0.7382, 0.7382+0.0460),
       ci_lower = c(0.6139, 0.7382-0.1047),
       ci_upper = c(0.8626, 0.7382+0.1967)) %>%
...
tibble(block_order = c("con first", "incon first"),
       alpha = c(0.6086, 0.6086+0.0630),
       ci_lower = c(0.4002, 0.6086-0.2466),
       ci_upper = c(0.8169,  0.6086+0.3726)) %>%
  mutate_if(is.numeric, transf.iabt) %>%
  mutate_if(is.numeric, round, digits = 2) %>%
  kable() %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"), full_width = FALSE)
...
tibble(response_options = c("static", "moving"),
       alpha = c(0.8937, 0.8937-0.2246),
       ci_lower = c(0.6707, 0.8937-0.4784),
       ci_upper = c(1.1167, 0.8937+0.0293)) %>%
  mutate_if(is.numeric, transf.iabt) %>%
  mutate_if(is.numeric, round, digits = 2) %>%
  kable() %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"), full_width = FALSE)
