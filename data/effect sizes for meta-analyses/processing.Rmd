...
data_cleaned_trt_outliers_removed <- data_cleaned_trt %>%
  full_join(data_cleaned_trt_outliers, by = "unique_id")
...
data_cleaned_ic_outliers_removed <- data_cleaned_ic %>%
  full_join(data_cleaned_ic_outliers, by = "unique_id")
...
data_demographics <- data_cleaned_ic_outliers_removed %>%
  distinct(unique_id, .keep_all = TRUE) %>%
