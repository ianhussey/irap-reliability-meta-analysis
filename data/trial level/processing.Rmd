...
henklain_2019 <- wrangle_data(file = "raw/shared by other labs/henklain et al 2019 - tidied/henklain_combined.csv") |>
  mutate(experiment = "Professor competence",
         unique_id = paste(experiment, participant))

vanderkaap_competence_needs_desire <- wrangle_data(file = "raw/shared by other labs/van der kaap et al - 2018/competence needs desire irap/competence needs desire irap data.csv") |>
  mutate(experiment = "Self-competence (am)",
         unique_id = paste(experiment, participant))

vanderkaap_competence_needs_satisfaction <- wrangle_data(file = "raw/shared by other labs/van der kaap et al - 2018/competence needs satisfaction irap/competence needs satisfaction irap data.csv") |>
  mutate(experiment = "Self-competence (want to be)",
         unique_id = paste(experiment, participant))
...
data_trial_level_temp_1 <- 
  bind_rows(data_evaluative,
            ...
            data_nonwords,
            henklain_2019,
            vanderkaap_competence_needs_desire,
            vanderkaap_competence_needs_satisfaction) %>%
  ...
  mutate(domain = dplyr::recode(domain,
                                ...
                                "Non-words" = "Non-words",
                                "Self-competence (am)" = "Self-competence (am)",
                                "Self-competence (want to be)" = "Self-competence (want to be)",
                                "Professor competence" = "Professor competence")) %>%
...
data_trial_level |>
  distinct(unique_id, met_performance_criteria_typical) |>
